Task Manager представляет собой одностраничное приложение, создано с помощью react-create-app. Это менеджер для хранения и просмотра задач пользователя в различных представлениях. 
